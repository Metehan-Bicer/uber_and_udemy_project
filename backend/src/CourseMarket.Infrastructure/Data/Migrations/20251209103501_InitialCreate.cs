    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LiveLessonRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LiveLessonRequests_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InstructorAssignments_LiveLessonRequests_RequestId",
                        column: x => x.RequestId,
                        principalTable: "LiveLessonRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstructorAssignments_RequestId",
                table: "InstructorAssignments",
                column: "RequestId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LiveLessonRequests_Status",
                table: "LiveLessonRequests",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_LiveLessonRequests_UserId",
                table: "LiveLessonRequests",
                column: "UserId");
